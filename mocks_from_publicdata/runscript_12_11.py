...
hh=cmhi.run('priority_lightcones/Lightcone_TNG50-1_mag32_12_11_xyz.txt',
            scale_arcsec=pdict[fkey],w_deg=0.0375,h_deg=0.0375,
            filtername=fdict[fkey],
            outfile='outputs/TNG50-1_12_11_xyz_'+fkey+'.fits')
